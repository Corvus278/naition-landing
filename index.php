...
<body>
    <header class="hero">
        <div class="container hero-content">
            ...
            <h1>Успеть помочь до&nbsp;приезда скорой</h1>
            <p class="hero-text">
                Кровотечение, остановка сердца, ожог, перелом&nbsp;&mdash; в&nbsp;первые минуты всё
                решают не&nbsp;медики, а&nbsp;человек рядом. За&nbsp;один практический день вы&nbsp;отработаете
                на&nbsp;манекенах и&nbsp;в&nbsp;парах то, что однажды может спасти жизнь: вашему ребёнку,
                коллеге или&nbsp;прохожему.
            </p>
            <div class="hero-cta">
                <a href="#registration" class="btn btn-hero">Записаться на&nbsp;курс</a>
                <span class="hero-cta-note">15&nbsp;августа 2026 &middot; до&nbsp;14 человек в&nbsp;группе &middot; оплата на&nbsp;месте, без&nbsp;предоплаты онлайн</span>
            </div>
            <div class="meta-grid">
                <div class="meta-card">
                    <strong>Дата</strong>
            ...
            <div class="container">
                ...
                <div class="program-list">
                    <details class="program-module" open>
                        <summary><h3>10:00 – 11:00 · Оценка обстановки и безопасность</h3></summary>
                        <p>
                    ...
                    <details class="program-module">
                        <summary><h3>11:00 – 12:30 · Сердечно-легочная реанимация</h3></summary>
                        <p>
                    ...
                    <details class="program-module">
                        <summary><h3>12:30 – 13:30 · Обед и разбор кейсов</h3></summary>
                        <p>
                    ...
                    <details class="program-module">
                        <summary><h3>13:30 – 15:00 · Кровотечения и шок</h3></summary>
                        <p>
                    ...
                    <details class="program-module">
                        <summary><h3>15:00 – 16:30 · Переломы, вывихи, ожоги</h3></summary>
                        <p>
                    ...
                    <details class="program-module">
                        <summary><h3>16:30 – 18:00 · Итоговая практика и сертификация</h3></summary>
                        <p>
            ...
            <div class="container">
                <div class="registration-panel">
                    ...
                    <form class="form-grid" id="registration-form" action="api/submit.php" method="post">
                        ...
                        <fieldset class="purpose-chips">
                            <legend>Зачем вам курс? <span class="optional">(необязательно)</span></legend>
                            <label class="chip">
                                <input type="radio" name="purpose" value="Для себя и близких" checked>
                                <span>Для&nbsp;себя и&nbsp;близких</span>
                            </label>
                            <label class="chip">
                                <input type="radio" name="purpose" value="Для работы">
                                <span>Для&nbsp;работы</span>
                            </label>
                            <label class="chip">
                                <input type="radio" name="purpose" value="Профессиональный интерес">
                                <span>Профессиональный интерес</span>
                            </label>
                        </fieldset>
